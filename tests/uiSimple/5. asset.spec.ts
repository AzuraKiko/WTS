...
test.describe('Asset Summary Tests', () => {
    ...
    test('TC_001: Check asset data', async ({ page }) => {
        // Check asset summary data
        ...
        await attachScreenshot(page, 'Portfolio Tất cả tiểu khoản');


        // Check investment performance data
        await assetPage.navigateToInvestmentPerformance();

        const subAccountTab = "Tất cả tiểu khoản";
        await assetPage.clickSubAccountTab(subAccountTab);
